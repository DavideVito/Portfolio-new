    ...
    <header className="text-gray-700 body-font">
      <div className="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
        ...
        >
          ...
          <span className="ml-3 text-xl">Davide Vitiello</span>
        </Link>
        <nav className="flex flex-wrap items-center justify-center space-x-4 text-base md:ml-auto">
          ...
          <Link
            ...
            to="/contact"
          >
            {lingua === "en" ? "Projects" : "Progetti"}
          </Link><Link
            activeClassName="font-black text-black"
            className="hover:text-gray-900"
            to="/myself"
          >
            {lingua === "en" ? "About me" : "Chi sono"}
          </Link>
        </nav>
      </div>
    </header>
    ...
    <div className="bg-gray-200">
      <div className="container flex flex-col flex-wrap px-5 py-4 mx-auto sm:flex-row">
        ...
        <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
          ...
          <a href="#no-link" className="ml-3 text-gray-500">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
...
const Links = ({ names }) => (
  <nav className="mb-10 list-none">
    {names.map((name) => (
      <li key={name}>
        <a href="#no-link" className="text-gray-600 hover:text-gray-800">
          {name}
        </a>
      </li>
    ))}
